...
namespace DocumentPlagiarismChecker.Comparators.ParagraphWordCounter
{
    ...
    {  
        ...
        public override ComparatorMatchingScore Run(){     
            ...
            ExcludeSamplePartialMatches(this.Left, 0.70f);  //TODO: El valor de alejamiento debe obtenerse de la configuración; comprobar si está quitado.
            ExcludeSamplePartialMatches(this.Right, 0.70f);  //TODO: El valor de alejamiento debe obtenerse de la configuración; comprobar si está quitado
        ...
        /// <summary>
        /// Compara la muestra con el archivo dado y excluye los párrafos que producen un falso positivo entre la muestra y el documento.
        /// </summary>
